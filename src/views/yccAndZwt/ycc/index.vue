 ...
 * @FilePath: /love-diary-client/src/views/yccAndZwt/ycc/index.vue
 * @Description: 
 * 
...
<template>
  <div class="ycc">
    <div class="grid">
      <img-card v-for="(item, index) in data.srcList" :key="index" :src="'http://121.5.130.175:8081/lovediary/yaochengcheng/' + item.url"></img-card>
    </div>
  </div>
</template>
